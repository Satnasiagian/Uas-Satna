...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Buku>|Buku query()
     ...
     */
    class Buku extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Peminjaman>|Peminjaman query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Peminjaman extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
